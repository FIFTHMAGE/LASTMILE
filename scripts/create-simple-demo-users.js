#!/usr/bin/env node
/**
 * Create Simple Demo Users for Local Testing (No Geospatial)
 */
...
// Simple user schema without geospatial indexes
...
const SimpleUser = mongoose.model('User', userSchema);

async function createDemoUsers() {
  console.log('🚀 Creating simple demo users for local testing...\n');

  // Demo users data (simplified)
  const demoUsers = [
    {
